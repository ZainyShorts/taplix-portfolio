          ...
          <div className="container-fluid">
            <div className="row g-xl-4 gy-5 divider">
              ...
              >
                <div className="single-approach">
                  <div className="img-area">
                    <img style={{objectFit:"cover"}}  src="https://images.pexels.com/photos/5716031/pexels-photo-5716031.jpeg?auto=compress&cs=tinysrgb&w=1200" alt="" />
                  </div>
                  <div className="dot">
                    <span />
                  </div>
              ...
              >
                <div className="single-approach">
                  <div className="img-area">
                    <img style={{objectFit:"cover"}}  src="https://images.pexels.com/photos/3183153/pexels-photo-3183153.jpeg?auto=compress&cs=tinysrgb&w=1200" alt="" />
                  </div>
                  <div className="dot">
                    <span />
                  </div>
              ...
              >
                <div className="single-approach">
                  <div className="img-area">
                    <img style={{objectFit:"cover"}} src="https://tse1.mm.bing.net/th?id=OIP.NatN5puI9xhxMx6xNp3XuwHaDt&pid=Api&P=0&h=220" alt="" />
                  </div>
                  <div className="dot">
                    <span />
                  </div>
              ...
              >
                <div className="single-approach">
                  <div className="img-area">
                    <img  style={{objectFit:"cover"}} src="https://tse2.mm.bing.net/th?id=OIP.bKe7mB4gCRBYammRXCWTggHaEO&pid=Api&P=0&h=220" alt="" />
                  </div>
                  <div className="dot">
                    <span />
                  </div>
