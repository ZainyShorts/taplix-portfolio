          ...
          <div className="row">
            <div className="col-lg-6 d-flex align-items-xxl-start align-items-center">
              <div className="banner-content">
                ...
                <h1>Build Smarter. Scale Faster. Tap Into Tomorrow.</h1>
                <p>
                  Technology moves fast. So should you. At Tapplix, we help bold startups and future-focused companies launch scalable software, integrate AI, and solve big challenges with smart code and smarter strategy. Ready to stop planning and start building?{" "}
                </p>
                ...
                <Swiper {...settings} className="swiper banner-img-slider">
                  <div className="swiper-wrapper">
                    <SwiperSlide className="swiper-slide">
                      <img src="https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTV8fG9mZmljZXxlbnwwfHwwfHx8MA%3D%3D" alt="" />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjB8fG9mZmljZXxlbnwwfHwwfHx8MA%3D%3D" alt="" />
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <img src="https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8bWVldGluZ3xlbnwwfHwwfHx8MA%3D%3D" alt="" />
                    </SwiperSlide>
                  </div>
                </Swiper>
              </div>
