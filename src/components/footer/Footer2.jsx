              ...
              <div className="col-lg-4 col-md-8 col-sm-6">
                <div className="footer-widget">
                  ...
                  <div className="content">
                    <p>
                      Welcome toTapplix, where innovation meets our passion in a
          ...
          <div className="contact-area">
            <div className="hotline-area">
              ...
              <div className="content">
                ...
                <h6>
                  <a href="tel:1 (800) 342-0989">1 (800) 342-0989</a>
                </h6>
              </div>
            </div>
            <div className="hotline-area">
...
Miami Beach, FL 33139
            ...
            <div className="hotline-area">
              ...
              <div className="content">
                <span>Say Hello</span>
                <h6>
                  <a href="mailto:info@tapplix.tech">info@tapplix.tech</a>
                </h6>
              </div>
            </div>
          </div>
