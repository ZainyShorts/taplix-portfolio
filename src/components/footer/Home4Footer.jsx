                ...
                <div className="home4-footer-wrap">
                    ...
                    <div className="row g-lg-4 gy-5 justify-content-center">
                      <div className="col-lg-4 col-md-6 col-sm-6">
                        <div className="footer-widget">
                          ...
                          <h2>
                            <a href="mailto:info@tapplix.tech">
                              info@tapplix.tech
                            </a>
                          </h2>
                          {/* <div class="content">
                                          <p>Welcome toTapplix, where innovation meets our passion in a journey that started with a simple idea and a shared dream.</p>
                                      </div> */}
                  ...
                  <div className="footer-bottom">
                    <div className="copyright-area">
                      <p>
                        Copyright 2024 <a href="#">Tapplix</a> | Design By{" "}
                        <a href="https://www.egenslab.com/">Tapplix</a>
                      </p>
                    </div>
