          ...
          <div className="row g-md-4 gy-5">
              ...
              <div className="blog-card">
                <div className="blog-card-img-wrap">
                  <Link href="#" className="card-img">
                    <img src="https://images.unsplash.com/photo-1676282824850-ba7df84c3b67?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8SG93JTIwdG8lMjBiZWVuJTIwcG9wdWxhdGlvbiUyMHRoZSUyMFN0YXJ0dXAlMjBjb21wYW55JTIwb2YlMjB0aGlzLnxlbnwwfHwwfHx8MA%3D%3D" alt="" />
                  </Link>
            ...
            >
              <div className="blog-card">
                <div className="blog-card-img-wrap">
                  <Link href="#" className="card-img">
                    <img style={{objectFit:"cover"}} src="https://images.unsplash.com/photo-1676276376140-a4030cc596a1?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8SG93JTIwdG8lMjBiZWVuJTIwcG9wdWxhdGlvbiUyMHRoZSUyMFN0YXJ0dXAlMjBjb21wYW55JTIwb2YlMjB0aGlzLnxlbnwwfHwwfHx8MA%3D%3D" alt="" />
                  </Link>
                  <Link href="#" className="date">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
            ...
            >
              <div className="blog-card">
                <div className="blog-card-img-wrap">
                  <Link href="#" className="card-img">
                    <img src="https://images.pexels.com/photos/3183153/pexels-photo-3183153.jpeg?auto=compress&cs=tinysrgb&w=1200" alt="" />
                  </Link>
                  <Link href="#" className="date">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
