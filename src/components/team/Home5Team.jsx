...
const Home5Team = () => {
    ...
    <div className="row">
      <div className="col-xxl-5 col-xl-4 d-flex flex-column gap-4 justify-content-between">
        <div className="section-title5 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
          ...
          <h2>Get to Know Creative <span> Minds AtTapplix.</span></h2>
  ...
  <div className="row g-4">
    <div className="col-md-6 col-sm-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
      <div className="team-card2">
        <div className="team-img">
          <img src="https://res.cloudinary.com/dsex1a9tu/image/upload/v1744591451/morgan_xxwffl.jpg" alt="" />
        ...
        <div className="team-content text-center">
          <h4>Morgan Shuler</h4>
          <span>CEO & Chief Technology Officer</span>
        </div>
      </div>
    </div>

    <div className="col-md-6 col-sm-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
      <div className="team-card2">
        <div className="team-img">
          <img src="https://res.cloudinary.com/dsex1a9tu/image/upload/v1744591458/branden_g9wnyy.jpg" alt="" />
          <ul className="social-area">
            <li><a href="https://www.facebook.com/"><i className="bx bxl-facebook" /></a></li>
            <li><a href="https://twitter.com/"><i className="bx bxl-twitter" /></a></li>
            <li><a href="https://www.pinterest.com/"><i className="bx bxl-pinterest-alt" /></a></li>
    ...
    <div className="col-md-6 col-sm-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
      <div className="team-card2">
        <div className="team-img">
          <img src="https://res.cloudinary.com/dsex1a9tu/image/upload/v1745082551/NETSAN_bett0p.jpg" alt="" />
          <ul className="social-area">
            <li><a href="https://www.facebook.com/"><i className="bx bxl-facebook" /></a></li>
            <li><a href="https://twitter.com/"><i className="bx bxl-twitter" /></a></li>
            <li><a href="https://www.pinterest.com/"><i className="bx bxl-pinterest-alt" /></a></li>
        ...
        <div className="team-content text-center">
          <h4>Netsanet Shamebo</h4>
          <span>Chief Product Officer</span>
        </div>
      </div>
    </div>

    <div className="col-md-6 col-sm-6 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
      <div className="team-card2">
        <div className="team-img">
          <img src="https://res.cloudinary.com/dsex1a9tu/image/upload/v1745082560/444_qapkq4.jpg" alt="" />
          <ul className="social-area">
            <li><a href="https://www.facebook.com/"><i className="bx bxl-facebook" /></a></li>
            <li><a href="https://twitter.com/"><i className="bx bxl-twitter" /></a></li>
            <li><a href="https://www.pinterest.com/"><i className="bx bxl-pinterest-alt" /></a></li>
        ...
        <div className="team-content text-center">
          <h4>Ali Hamza</h4>
          <span>Team Lead AI Engineer</span>
        </div>
      </div>
    </div>
  </div>
