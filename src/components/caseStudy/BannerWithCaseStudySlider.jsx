        ...
        <div className="row g-0">
          <div className="col-xl-4 col-lg-5">
            <div className="banner-area">
              <img src="https://images.unsplash.com/photo-1706466614967-f4f14a3d9d08?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fGFpfGVufDB8fDB8fHww" alt="" />
              <div className="banner-content">
                ...
                >
                  ...
                  <h1 style={{color:"white"}}>Success in the Field: Case Studies & Thought Leadership</h1 >
                </div>
                <div
                ...
                >
                  <p>
                    Explore how Tapplix delivers powerful results through custom-built software, AI-driven innovation, and expert insight published on Forbes Technology Council.
                  </p>
                  {/* <Link
                    href="/c"
                ...
                <div className="swiper-wrapper">
                  <SwiperSlide className="swiper-slide">
                    <div className="case-study-card">
                      <div className="card-img">
                        <img
                          src="assets/brandings/forbes.jpeg"
                          alt=""
                        />
                      </div>
                      <div className="card-content">
                        ...
                        <h4>
                          {/* <Link href="#"> */}
                          <a href="https://councils.forbes.com/profile/Morgan-Shuler-Founder-Chief-Technology-Officer-Tapplix-Applications-Web-Design/c7ba1203-6c48-4c60-bc5c-d8cdecfe27c5">
                        ...
                        <a
                          href="https://councils.forbes.com/profile/Morgan-Shuler-Founder-Chief-Technology-Officer-Tapplix-Applications-Web-Design/c7ba1203-6c48-4c60-bc5c-d8cdecfe27c5"
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="case-study-card">
                      <div className="card-img">
                        <img
                          src="assets/brandings/coche.jpeg"
                          alt=""
                        />
                      </div>
                      <div className="card-content">
                        <Link href="#">MOBILITY TECH | AI + WEB3</Link>
                        <h4>
                          <Link href="#">
                            Rideshare Reinvented: The CocheVia Platform
                          </Link>
                        </h4>
                        <p>
                          This case study reveals how Tapplix built CocheVia, an AI-powered, driver-first rideshare platform with integrated Web3, AI, and advanced mobility for all users.
                        </p>
                        <Link
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="case-study-card">
                      <div className="card-img">
                        <img
                          src="assets/brandings/ebonix.jpeg"
                          alt=""
                        />
                      </div>
                      <div className="card-content">
                        <Link href="#">AI PLATFORM | CULTURE-FIRST INTELLIGENCE</Link>
                        <h4>
                          <Link href="#">
                            Building Culturally Fluent AI: The Ebonix Experience
                          </Link>
                        </h4>
                        <p>
                          This case study explores how Tapplix brought Ebonix AI to life,a generative AI platform designed to reflect diverse cultural identities. Built using GPT-2, TensorFlow, Hugging Face and a custom prompt engine.
                        </p>
                        <Link
                          href="/case-study/case-study-details"
                          className="learn-more-btn"
                  ...
                  {/* <SwiperSlide className="swiper-slide">
                    <div className="case-study-card">
                      <div className="card-img">
                        <img
                          src="https://img.freepik.com/free-vector/gradient-devops-illustration_23-2149373211.jpg?ga=GA1.1.1246748459.1736059899&semt=ais_hybrid&w=740"
                          alt=""
                        />
                      </div>
                      <div className="card-content">
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="case-study-card">
                      <div className="card-img">
                        <img
                          src="https://img.freepik.com/free-vector/software-requirement-description-abstract-concept-illustration_335657-3813.jpg?ga=GA1.1.1246748459.1736059899&semt=ais_hybrid&w=740"
                          alt=""
                        />
                      </div>
                      <div className="card-content">
