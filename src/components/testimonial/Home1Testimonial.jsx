                          ...
                          <div className="author-area">
                            <div className="author-img">
                              <img
                                ...
                                src="https://img.freepik.com/free-photo/portrait-white-man-isolated_53876-40306.jpg?ga=GA1.1.1246748459.1736059899&semt=ais_hybrid&w=740"
                                alt=""
                              />
                            </div>
                        ...
                        <div className="author-and-logo-area">
                          <div className="author-area">
                            <div className="author-img">
                              <img
                               style={{objectFit:"cover"}}
                                src="https://img.freepik.com/free-photo/young-bearded-man-with-striped-shirt_273609-5677.jpg?ga=GA1.1.1246748459.1736059899&semt=ais_hybrid&w=740"
                                alt=""
                              />
                            </div>
                            <div className="content">
                        ...
                        <div className="author-and-logo-area">
                          <div className="author-area">
                            <div className="author-img">
                              <img
                               style={{objectFit:"cover"}}
                                src="https://img.freepik.com/free-photo/close-up-portrait-curly-handsome-european-male_176532-8133.jpg?ga=GA1.1.1246748459.1736059899&semt=ais_hybrid&w=740"
                                alt=""
                              />
                            </div>
                            <div className="content">
                        ...
                        <div className="author-and-logo-area">
                          <div className="author-area">
                            <div className="author-img">
                              <img
                               style={{objectFit:"cover"}}
                                src="https://img.freepik.com/free-photo/handsome-happy-bearded-man_74855-2827.jpg?ga=GA1.1.1246748459.1736059899&semt=ais_hybrid&w=740"
                                alt=""
                              />
                            </div>
                            <div className="content">
